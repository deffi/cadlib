...
def render_to_file(object, file_name, fn = None):
    # TODO single responsibility: creates the header, converts to ScadObject,
    # renders to code, writes to file. Add ScadFile, probably. Also, we want to
    # be able to render either an ScadObject or an Object (requires a call to
    # to_scad()).
